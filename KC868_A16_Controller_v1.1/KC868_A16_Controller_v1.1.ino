...
// Update saveHTSensorConfig function to add better debugging
// Update saveHTSensorConfig function to add better debugging
...
// Make sure this function is implemented correctly in the Arduino code
...
// Modify the handleHTSensors function to add debugging
// Modify the handleHTSensors function to add debugging
